                ...
                children: [
                  ...
                  MacosListTile(
                    leading: MacosCheckbox(
                      value: config.skipCidrFirstAddr,
                      onChanged: (value) => configNotifier.updateSkipCidrFirstAddr(value ?? false),
                    ),
                    title: const Text('Skip First Address in CIDR Range'),
                  ),
                  MacosListTile(
                    leading: MacosCheckbox(
                      value: config.skipCidrLastAddr,
                      onChanged: (value) => configNotifier.updateSkipCidrLastAddr(value ?? false),
                    ),
                    title: const Text('Skip Last Address in CIDR Range'),
                  ),
                ],
              ),
            );
